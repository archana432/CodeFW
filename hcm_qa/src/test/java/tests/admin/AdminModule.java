...
public class AdminModule {
	 ...
	 */
	@Test(description = "TC08_Admin_CreateNewUser_CheckRole_Admin",groups = {"Func Only"})
	 ...
	 * @author  Shwetha sep 11, 2019
	 */
	@Test(description = "TC13_Admin_CreateNewUser_CheckRole_Fms",groups = {"Func Only"})
	 ...
	 */
	@Test(description = "TC14_Admin_CreateNewUser_CheckRole_Fms_Incidents",groups = {"Func Only"})
		...
		staffMembers.addCrmUser(uname);
		 ...
		 if(login.logoutThenPerformLogin(uname,pwd)) {
		  CustomReporter.report(STATUS.PASS,"CRM user is able to login into application");
			...
			nav.traverseMenu_VerifyPageTitle(Crm_Dashboard.title, dash.link_CRM_User);
